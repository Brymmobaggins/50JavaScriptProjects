...
const acorn = acorn_1.Parser.extend(require("acorn-class-fields"), require("acorn-static-class-features"), require("acorn-private-class-elements"));
...
async function analyze(id, code, job) {
    ...
    function validWildcard(assetPath) {
        ...
        if (dir.startsWith(assetPath.substr(0, assetPath.length - wildcardSuffix.length) + path_1.default.sep))
            return false;
        // do not emit asset directories higher than the node_modules base if a package
        if (pkgBase) {
            const nodeModulesBase = id.substr(0, id.indexOf(path_1.default.sep + 'node_modules')) + path_1.default.sep + 'node_modules' + path_1.default.sep;
